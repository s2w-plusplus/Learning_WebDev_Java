...
public class ATMImpl implements ATM {
	...
	private ATMImpl(Transport t123) { //purposedly made private contructor
		myTransport = t123;
	...
	public static ATMImpl myFactory(Transport t)
	{
		...
		return new ATMImpl(t);//dependent obj creation n linking -->still has to be done by Programmer
	}
