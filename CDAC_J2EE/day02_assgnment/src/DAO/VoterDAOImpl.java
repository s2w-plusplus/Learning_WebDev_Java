...
public class VoterDAOImpl implements IVoterDAO {
	...
	public Voter authenticateVoter(String email, String passwd) throws SQLException {
		...
		{
			if(rSet.next())  
				return (new Voter(rSet.getInt(1),rSet.getString(2),rSet.getString(3),rSet.getString(4),rSet.getBoolean(5)));		
			 return null;
		}
	}
	...
	public String updateVotingStatus(int voterId) throws SQLException {
		...
		return "Status Updation was "+((status==1)?"Successful":"Unsuccessful");
	}
